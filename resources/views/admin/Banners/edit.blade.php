                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="type" id="bannerType">
                                                        ...
                                                        <option value="video_url" @if($result['banners'][0]->type=='video_url') selected @endif>Video</option>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Old Video</span>
                                                    <br>
                                                    <video width="400" controls>
                                                        <source src="{{asset($result['banners'][0]->banners_url)}}" type="video/mp4">
