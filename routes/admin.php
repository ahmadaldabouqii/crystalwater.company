...
Route::group(['middleware' => ['installer']], function () {
    ...
    Route::group(['namespace' => 'AdminControllers', 'middleware' => 'auth', 'prefix' => 'admin'], function () {
        ...
        //city
        Route::get('/city', 'AdminCityController@city')->middleware('website_routes');
        Route::get('/add-city', 'AdminCityController@addCity')->middleware('website_routes');
        Route::post('/store-city', 'AdminCityController@storeCity')->middleware('website_routes');
        Route::get('/edit-city/{id}', 'AdminCityController@editCity')->middleware('website_routes');
        Route::post('/update-city/{id}', 'AdminCityController@updateCity')->middleware('website_routes');
        Route::post('/delete-city', 'AdminCityController@deleteCity')->middleware('website_routes');
